...
bot.findBlock(options); // Return the nearest block (not position) matching the specified options. `options` is `FindBlockOptions`. Important: must use block.position to get `Vec3` position for use in other functions like depositItemIntoChest
